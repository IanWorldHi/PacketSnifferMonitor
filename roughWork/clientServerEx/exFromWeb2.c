//Different, uses promiscuous mode
//wriptes to .pcacp wireeshark ro smth, refreshes every 2 hrs which is nice tho
//https://github.com/Nyveruus/systems-programming/blob/main/projects/networking/packet-sniffer/main.c 
